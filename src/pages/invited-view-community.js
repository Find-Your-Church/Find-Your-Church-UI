																		...
																		{this.props.community.view_community.pictures.map((pic, index) => {
																			return (
																				<div className="each-slide" key={index}>
																					<div style={{backgroundImage: isEmptyFile(`${app_config.FYC_API_URL}/static/pictures/${this.props.community.view_community._id}-${index}.${pic}`) ? `url('/img/default-community/5e2672d254abf8af5a1ec82c_Community-p-500.png')` : `url(${app_config.FYC_API_URL}/static/pictures/${this.props.community.view_community._id}-${index}.${pic})`}}>
																					</div>
																				</div>
																			);
																		})}
															...
															: (this.props.community.view_community.pictures.length > 0 ? (
																<div className="slide-container">
																	<div className="each-slide">
																		<div
																			style={{backgroundImage: isEmptyFile(`${app_config.FYC_API_URL}/static/pictures/${this.props.community.view_community._id}-0.${this.props.community.view_community.pictures[0]}`) ? `url('/img/default-community/5e2672d254abf8af5a1ec82c_Community-p-500.png')` : `url(${app_config.FYC_API_URL}/static/pictures/${this.props.community.view_community._id}-0.${this.props.community.view_community.pictures[0]})`}}>
																		</div>
																	</div>
																</div>
															) : (
