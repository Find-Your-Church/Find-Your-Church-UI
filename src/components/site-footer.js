		...
		return (
			<div className={"footer-container"}>
				{/* <div className={"footer-head"}> */}
					{/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.5 27.8" preserveAspectRatio="none" fill="#1B0033">
				...
				<footer className="footer-div" style={{filter: this.props.overlayed ? "blur(4px)" : "none"}}>
					<div className={"left-part"}>
						...
						<div className={"footer-link"}>
							<Link to="/goto-url/www.facebook.com/everydaybelievers1">
								Like us on Facebook
							</Link>
						</div>
						<div className={"footer-link"}>
							<Link to="/goto-url/instagram.com/everyday.believers">
						...
						<div className={"w3-modal-content w3-card-4 w3-animate-zoom"}>
							<header className={"w3-container w3-border-bottom"}>
								<span onClick={this.hideModal}
											className={"close-button w3-button w3-xxlarge w3-display-topright w3-hover-text-white"}>&times;</span>
